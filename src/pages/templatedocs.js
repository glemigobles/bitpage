...
class Templatedocs extends Component {
    ...
    handleDisplayModal2 = () => {
        if (this.state.displayModal2 === false) {
                ...
                <Sidebar>
                    ...
                    <Backbox color="light" addClass="partial column">
                        ...
                        <Backbox color="outlined" addClass="partial column">
                            ...
                            <AnchorLink href='#modal' offset="50"><p>Modal</p></AnchorLink>
                ...
                <div className="page2 wrapper partial start-v column margin-l">
                    ...
                    <Backbox color="outlined" addClass='partial column margin-top margin-btm'>
                        <Sectionhead subtitleAnimation="fadeInLeft" lineAnimation="fadeInLeft"
                            ...
                            title={'Modal'} subtitle={'<Modal>{children.content}</Modal>'}></Sectionhead >
                        <Backbox addClass='partial column center-v center-h margin-top margin-btm'>
                            <Button onClick={this.handleDisplayModal}>open modal</Button>
                            <Modal label="modal label" display={this.state.displayModal} onClose={this.handleDisplayModal}>
                                this is default modal
                            </Modal>
                            <Button onClick={this.handleDisplayModal2}>open modal with buttons</Button>
                            <Modal label="modal label"
                                buttonOk={() => { alert('ok cliked!') }}
                                buttonCancel={() => { alert('cancel cliked!') }}
                                display={this.state.displayModal2}
                                onClose={this.handleDisplayModal2}>
                                this is modal with buttons
                            </Modal>
                        </Backbox>
                        <Backbox color="dark" addClass="partial" >
                            <b>Component options:</b>
                        ...
                        <Backbox color="outlined" addClass="partial column">
                            ...
                            <p><b>addClass:</b> (string) - class/clsses names </p>
                            <hr className="partial"></hr>
                            <p><b>display:</b> (boolean) - true/false </p>
                            <hr className="partial"></hr>
                            <p><b>label:</b> (string)</p>
                            <hr className="partial"></hr>
                            <p><b>buttonOk:</b> (function)</p>
                            <hr className="partial"></hr>
                            <p><b>buttonOkName:</b> (string)</p>
                            <hr className="partial"></hr>
                            <p><b>buttonCancel:</b> (function)</p>
                            <hr className="partial"></hr>
                            <p><b>buttonCancelName:</b> (string)</p>
                            <hr className="partial"></hr>
                            <p><AnchorLink offset="100" href="#animation-options"><b>animation options:</b> go to options</AnchorLink></p>
                            <hr className="partial"></hr>
                        </Backbox>
